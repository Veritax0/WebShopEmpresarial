...
const ProductDetail = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap  ">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded " src={`/${product.id}.png`}/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 bg-white">
        <h2 class="text-4xl title-font text-gray-500 tracking-widest">{product.nombre}</h2>
        ...
        <div class="flex">
          <span class="title-font font-medium text-5xl text-violet-700">${product.precio}</span>
          <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={handleAddToCart}>Agregar al carrito</button>
        ...
        <div className="cantidad flex items-center space-x-2 bg-gray-100 p-2 rounded-lg">
    <button onClick={decrementarCantidad} className="bg-violet-600 text-white font-bold px-4 py-2 rounded hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50">
        -
    </button>
    <span className="text-lg font-semibold">{cantidad}</span>
    <button onClick={incrementarCantidad} className="bg-violet-600 text-white font-bold px-4 py-2 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
        +
    </button>
</div>
