        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <form className="w-full max-w-md" onSubmit={handleSubmit}>
                    <h1 className="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">Ingresar</h1>
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4 text-center text-gray-600 dark:text-gray-400">o inicia sesión con</p>
